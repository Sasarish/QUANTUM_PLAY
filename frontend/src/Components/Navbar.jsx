...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 w-full bg-white shadow-md z-50">
          ...
          {!isAuthenticated ?
            (
              <div className="hidden sm:flex items-center gap-4">
                ...
                <Link
                  to="/register"
                  className="hidden sm:flex gap-2 items-center bg-gray-900 text-white px-4 py-2 rounded-lg hover:bg-black transition"
                >
                  <User size={18} />
                  Register
                </Link>
      ...
      {/*Mobile section*/}
      <div
        className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out ${open ? "max-h-112.5 opacity-100 translate-y-0" : "max-h-0 opacity-0 -translate-y-2"}`}
      >
          ...
          {!isAuthenticated ? (
            ...
            <div className="flex flex-col gap-4 border-t border-gray-200 pt-4 mt-2">
              ...
              <button
                ...
                className="text-left text-red-500 hover:text-red-600 transition font-semibold"
              >
                Logout
              </button>
